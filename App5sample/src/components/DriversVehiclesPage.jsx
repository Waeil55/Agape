...
const DriversVehiclesPage = ({ role, drivers, setDrivers, addAuditLog, currentUser, trips, onAssignTrip, onUploadForDriver, requestAuthAction }) => {
  ...
  const [form, setForm] = useState({ 
    ...
    licenseNumber: '', cdlStatus: 'Active'
  });
  ...
  const resetForm = () => setForm({ name: '', email: '', phone: '', vehicle: '', status: 'Available', currentZone: '' });
