  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'xl': ['var(--text-xl)', { lineHeight: 'var(--leading-snug)', fontWeight: '400' }],
        '2xl': ['var(--text-2xl)', { lineHeight: 'var(--leading-snug)', fontWeight: '500' }],
        '3xl': ['var(--text-3xl)', { lineHeight: 'var(--leading-tight)', fontWeight: '600' }],
        '4xl': ['var(--text-4xl)', { lineHeight: 'var(--leading-tight)', fontWeight: '700' }],
        '5xl': ['var(--text-5xl)', { lineHeight: '0.95', fontWeight: '700' }],
      },
      borderRadius: {
        'card': 'var(--radius-2xl)',
