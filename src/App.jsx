          ...
          <div className="lg:col-span-4 space-y-4 sm:space-y-6">
            <div className="bg-white/80 backdrop-blur-xl rounded-[1.5rem] p-4 sm:p-6 border border-white shadow-[0_8px_30px_-12px_rgba(0,0,0,0.1)]">
              <div className="flex justify-between items-center mb-4 sm:mb-6">
                <h3 className="text-[10px] sm:text-[11px] font-black text-slate-900">Live Fleet</h3>
                <div className="flex items-center gap-3">
                    ...
                    <div key={d.id} className={`p-3 sm:p-4 rounded-xl sm:rounded-[1.5rem] active:scale-[0.98] transition-all cursor-pointer ${isMaintenanceDue ? 'bg-rose-50 border border-rose-100' : 'bg-slate-50 border border-slate-100/50'}`}>
                      <div className="flex items-center justify-between mb-2 sm:mb-3">
                        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                          <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-[1rem] bg-blue-100 text-blue-600 flex items-center justify-center font-bold shrink-0 text-[10px] sm:text-[11px]">{d.name.charAt(0)}</div>
                          <div className="min-w-0">
                            <p className="font-bold text-[10px] sm:text-[11px] truncate text-slate-900">{d.name}</p>
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-[1.5rem] p-4 sm:p-6 border border-white shadow-[0_8px_30px_-12px_rgba(0,0,0,0.1)]">
              <h3 className="text-[10px] sm:text-[11px] font-black text-slate-900 mb-3 sm:mb-4 flex items-center gap-2"><Activity size={16} className="text-indigo-600" /> System Pulse</h3>
              ...
              {(() => {
                ...
                return (
                  <button
                    ...
                    className={`py-2 sm:py-3 px-2.5 sm:px-3 border-b-2 font-bold flex items-center justify-center gap-1.5 sm:gap-2 transition text-[10px] sm:text-[11px] ${
                      activeTab === tab.id
                ...
                {(role === 'admin') && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    >
                      ...
                      <p className="text-[10px] sm:text-[11px] opacity-90">Import from CSV/Excel</p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      <p className="text-[10px] sm:text-[11px] opacity-90">Manually create a new trip</p>
                    </button>
                  </div>
                )}
