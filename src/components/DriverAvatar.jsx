      ...
      {showUpload && (
        <>
          <button
            ...
            disabled={uploading}
            className="absolute -bottom-1 -right-1 w-6 h-6 bg-[#23568E] text-white rounded-full flex items-center justify-center shadow-md hover:bg-[#1a4270] transition-colors cursor-pointer"
          >
