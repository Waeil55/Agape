              ...
              {navItems.map((item) => {
                ...
                return (
                  <button key={item.id} onClick={() => {
                    ...
                    <span className={`max-w-full truncate text-[10px] tracking-[0.04em] transition-all leading-none ${isActiveTab ? 'text-[#1b5cb7] font-bold' : 'text-[#94a3b8] font-medium'}`}>{item.label}</span>
                  </button>
                );
              })}
            </div>
