...
Answer in 2-3 sentences maximum. Be specific and actionable.` }] }],
  ...
  return (
    <>
      {open && (
        <div className="fixed bottom-[calc(96px+env(safe-area-inset-bottom,0px))] right-5 z-[9999] w-80 h-96 bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col overflow-hidden animate-in slide-in-from-bottom-4">
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-2 bg-slate-50">
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="card-premium px-2.5 py-1.5 flex items-center gap-2">
      ...
      <button onClick={() => setOpen(v => !v)}
        className="fixed bottom-[calc(80px+env(safe-area-inset-bottom,0px))] right-5 z-[9999] w-12 h-12 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-full shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center">
