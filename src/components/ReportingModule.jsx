  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 p-6 max-w-2xl">
      ...
      <div className="space-y-4">
        {/* Report Type */}
        <div>
          <label className="block text-sm font-bold text-slate-900 mb-2">Report Type</label>
          <select
            value={reportType}
        ...
        {/* Time Range */}
        <div>
          <label className="block text-sm font-bold text-slate-900 mb-2">Time Range</label>
          <select
            value={timeRange}
    ...
    <div className="flex-1 flex flex-col bg-slate-50 overflow-auto">
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              <p className="text-sm font-bold text-slate-600 mb-2">Quick Export</p>
              <QuickExport data={{
