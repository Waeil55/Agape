  ...
  switch (density) {
    ...
    case 'sparse':
      return {
        ...
        cardTime: 'text-xs',
        sectionGrid: 'lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]',
        tableHead: 'px-3 py-0.5',
        tableCell: 'px-3 py-0.5',
        tableRowMinHeight: 'min-h-[38px]',
        showPhones: true,
        showNotes: true,
        showRoutes: true,
        showAssignmentMeta: true,
    ...
    <div data-scroll-region="operations-ledger" className="min-h-0 flex-1 overflow-y-auto overscroll-contain touch-pan-y px-3 pb-3">
      {manifestFeedTrips.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="flex h-8 items-center justify-between gap-3 border-b border-slate-200 bg-slate-50/90 px-3">
